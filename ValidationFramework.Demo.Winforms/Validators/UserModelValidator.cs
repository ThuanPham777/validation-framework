    ...
    public class UserModelValidator : AbstractValidator<UserModel>
    {
        public UserModelValidator()
        {
         ...
         .Length(3, 20)
               .AlphaNumeric()
                 .NoSpecialChars()
       .WithMessage("Username must be 3-20 alphanumeric characters without special characters");
          ...
          .Required()
             ...
             .WithMessage("Email must be from gmail.com, outlook.com, or yahoo.com");
           ...
           .WithMessage("Password must be at least 8 characters with uppercase, lowercase, and digit");
